...
RUN curl -o /tmp/apt_select.zip -L https://github.com/jblakeman/apt-select/archive/master.zip && \
cd /tmp && \
unzip apt_select.zip && \
mv apt-select-master /app/aptselect && rm -rf /tmp/*
